...
urlpatterns = [
    ...
    # path('profile2/<int:pk>/', create_profile2, name='create_profile'),
    ...
    path('orders/<int:order_pk>/offers/<int:offer_pk>/second_destination_receipt/', upload_second_destination_cost_receipt, name='upload_second_destination_cost_receipt'),
