# Generated by Django 4.1.1 on 2023-01-01 09:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_number', models.CharField(blank=True, max_length=35, null=True)),
                ('order_number_file', models.CharField(blank=True, max_length=35, null=True)),
                ('order_number_seen_status', models.BooleanField(blank=True, default=False, null=True)),
                ...
                ('deal_draft', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='prescript', to='orders.paperwork')),
