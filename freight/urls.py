...
urlpatterns = [
    ...
    path('orders/<int:order_pk>/update_offer/<int:offer_pk>/', update_offer, name='freight_update_offer'),
    path('orders/offers/', offers, name='freight_offers'),
    path('offers/<int:offer_pk>/', offer_detail, name='freight_offer_detail'),
