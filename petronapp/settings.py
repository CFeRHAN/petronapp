...
SECRET_KEY = 'django-insecure-swsrl(!dn=o=ffghbo^7#6pkqs^*m1q8-(hh6ay=36ajel)!cu'
...
INSTALLED_APPS = [
    ...
    'flow_manager.apps.FlowManagerConfig',
]
...
WSGI_APPLICATION = 'petronapp.wsgi.application'
